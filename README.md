...
## Corrección cuenca subdimensionada
Esta versión corrige el módulo de cuenca y morfometría para evitar resultados artificialmente pequeños:

- incorpora relleno hidrológico de depresiones antes del D8;
- selecciona el punto de salida por mayor acumulación y área aguas arriba;
- agrega diagnóstico de candidatos por radio;
- aumenta radios de ajuste por defecto;
- mantiene el módulo Eje Cauce y Secciones v15 integrado.
